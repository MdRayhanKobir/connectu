                ...
                <form action="{{route('admin.plan.update',$plan->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="row mb-2">
                                ...
                                @if(@$plan->content)
                                    @foreach(json_decode(@$plan->content) as $key => $value)
                                        <div class="row mb-2 content-field">
                                            ...
                                            <div class="col-2">
                                                <button type="button" class="btn text--white btn--danger removePlanContent"><i class="la la-times"></i></button>
                                            </div>
                                        </div>
                                    @endforeach
                                @endif
                            ...
                            <div class="col-2">
                                <button type="button" class="btn btn--primary addPlanContent ms-0"><i class="fa fa-plus"></i> @lang('Add')</button>
                            </div>
                        </div>
